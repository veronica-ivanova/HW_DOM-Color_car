...
// Получаем переменную переменную цвета авто (тэг img)
var imgColor = document.querySelector('img[alt="Автомобиль"]');
console.log(imgColor)
...
for (i = 0; i < colorItems.length; i++) {
    ...
    colorItems[i].addEventListener('click', function(){
        ...
        // Меняем общий путь к файлу, подставляя значение атрибута data-color
        imgColor.src = `//webcademy.ru/files/js2020/solaris/${this.dataset.color}.png`;
    });
}
